...
import com.ai.paas.i18n.MultiResourceBundle;
...
public class ResourceUtil {
    ...
    static {
        ...
        rb = MultiResourceBundle.getBundle("com.ai.paas.paas-common", locale);
    }

    public static void addBundle(String baseName, Locale locale) {
        try {
            if (log.isInfoEnabled()) {
                log.info("Add localization file:{},,locale:{} to i18n!", baseName, locale);
            }
    ...
    public static void main(String[] args) {
        log.info(ResourceUtil.getMessage("com.ai.paas.ipaas.common.srvid_null"));
        String[] values = { "sss", "ssssd", "ggggg", "hhhhh", "iiiiiiii" };
        log.info(ResourceUtil.getMessage("com.ai.paas.ipaas.common.test", values));
