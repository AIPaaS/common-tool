...
public class StringUtil {
    ...
    static {
        try {
            ...
            log.error("Can not init random", e);
        }
    }
    ...
    /**
     * 判断 src 字符串，是否在 des 字符串范围内（ des字符串，是使用 splitChar 进行分隔的多个字符串组成的）； 例如 判断 1 是否在
     * 1,2,3 内；(分隔符是 ,); 如果 src 为空 或者 des 为空，那么返回 false ;不需要判断；
     * 
     * @param des
     * @param splitChar
     * @param src
